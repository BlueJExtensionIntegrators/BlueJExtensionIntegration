...
public final class BlueJManager {
     ...
     */
    public void setBlueJ(final BlueJ aBlueJ) {
        mBlueJ = aBlueJ;
     ...
     * @throws PackageNotFoundException if a package is not found.
     */
    public Set<BClass> getBClasses(final BProject aProject)
        throws ProjectNotOpenException,
               PackageNotFoundException {
     ...
     * @throws PackageNotFoundException if a package is not found.
     */
    public Set<BClass> getBClasses(final BPackage aPackage)
        throws ProjectNotOpenException,
               PackageNotFoundException {
    ...
    private InputStream getResourceStream(final String name,
        ...
        if (result == null && defaultName != null
                && !defaultName.equals(name)) {
     ...
     * use in error messages.
     */
    private void missingResourceMessage(final String name, final String defaultName,
                                        final String description) {
     ...
     */
    private InputStream getResourceStream(final String resourceLocation) {
     ...
     */
    public void saveConfigFileName(final String aName) {
     ...
     */
    public void savePropsFileName(final String aName) {
        String old = mBlueJ.getExtensionPropertyString(
            PROPS_FILE_NAME_KEY, null);
        if (old != null && !old.equals("")) {
            mMissingResources.remove(old);
     ...
     */
    public void initAuditFrame(final AuditFrame aFrame) {
        // location and size
     ...
     */
    public void saveAuditFrame(final AuditFrame aFrame) {
